let words = ['MATEUS','PEDRO','JUDAS','MARCOS', 'LUCAS', 'APOCALIPSE','JOAO', 'ROMANOS', 'CORINTIOS', 'GALATAS', 'EFESIOS','FILIPENSES', 'COLOSSENSES', 'TESSALONICENSES', 'TIMOTEO', 'TITO', 'FILEMON', 'HEBREUS', 'TIAGO'];
let wrongLetters = [];
let rightLetters = [];
let attempts;
let correct;
